...
#define GPIO_ZM516X_MOTOR_EN_BV    BV(5)
#define GPIO_ZM516X_MOTOR_PHASE_BV    BV(4)
...
#define GPIO_ZM516X_MOTOR_EN_SBIT    P1_5
#define GPIO_ZM516X_MOTOR_PHASE_SBIT    P1_4
...
#define GPIO_ZM516X_MOTOR_EN_DDR                       P1DIR
#define GPIO_ZM516X_MOTOR_PHASE_DDR                       P1DIR
...
#define GPIO_ZM516X_MOTOR_EN_TURN_HIGH()    GPIO_ZM516X_MOTOR_EN_SBIT = 1;
#define GPIO_ZM516X_MOTOR_PHASE_TURN_HIGH()    GPIO_ZM516X_MOTOR_PHASE_SBIT = 1;
...
#define GPIO_ZM516X_MOTOR_EN_TURN_LOW()    GPIO_ZM516X_MOTOR_EN_SBIT = 0;
#define GPIO_ZM516X_MOTOR_PHASE_TURN_LOW()    GPIO_ZM516X_MOTOR_PHASE_SBIT = 0;
